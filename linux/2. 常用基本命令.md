...
# 相对路径进入usr目录
[root@kuangshen /]# cd ../usr

# 绝对路径进入 kuangstudy 目录
[root@kuangshen home]# cd /home/kuangstudy
...
# 创建权限为 rwx--x--x 的目录。
[root@kuangshen home]# mkdir -m 711 te st2
...
# 创建f1的一个硬连接文件f2
[root@kuangshen home]# ln f1 f2

# 创建f1的一个符号连接文件f3
[root@kuangshen home]# ln -s f1 f3

# -i参数显示文件的inode节点信息
[root@kuangshen home]# ls -li
